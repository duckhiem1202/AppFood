...
import 'package:myappappsa/commons/widgets/progress_listener_widget.dart';
...
import 'package:myappappsa/presentations/features/sign_in/sign_in_bloc.dart';
              ...
              onTap: () {
                Navigator.pushNamed(context, "/sign-up").then((value) {
                  if(value != null){
                    ...
                    String password = (value as Map)['password'];
        ...
        child: ElevatedButtonTheme(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                ...
                _bloc.eventSink.add(LogninEvent(email: email, password: password));
              },
            )));
  }
}
